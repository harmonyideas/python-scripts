...
# DESCRIPTION: Search Fortinet Config File by Object Reference ­ Global Matches are
# Supported (ex. "config vpn ipsec" or "config vpn ipsec phase1­interface")
#
use strict;
if ( $#ARGV != 1 ) {
...
my $line = "";
my $string = "";
# escape harmful characters for regex
